...
#define STRING_CONFIG_H_AUTHOR "(admirable-pomelo)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 127.29
  #define DEFAULT_bedKi 24.42
  #define DEFAULT_bedKd 442.23
...
#define LCD_BED_LEVELING
  ...
  #define MESH_EDIT_Z_STEP  0.012 // (mm) Step size while manually probing Z axis.
